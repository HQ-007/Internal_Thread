...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default='', help='initial weights path') #yolyv5s可以选择其他的模型
    parser.add_argument('--cfg', type=str, default='models/yolov5m2.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/train.yaml', help='dataset.yaml path')##写在train当前目录的下面
    ...
    parser.add_argument('--project', default='runs/train/实验', help='save to project/name')#权重保存的路径
