...
def parse_opt():
    ...
    #parser.add_argument('--weights', nargs='+', type=str, default='runs/train/exp_5s/exp5/weights/best.pt',help='model.pt path(s)')
    parser.add_argument('--source', type=str, default='/home/huangqing/YOLOv5_内螺纹/yolov5-master/dataset/images1/new', help='file/dir/URL/glob, 0 for webcam')
    #parser.add_argument('--source', type=str, default='/home/huangqing/YOLOv5_内螺纹/yolov5-master/dataset/val',help='file/dir/URL/glob, 0 for webcam')
