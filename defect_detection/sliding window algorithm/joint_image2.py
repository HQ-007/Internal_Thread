...
def get_label_info(labels_path, mix_percent, rows, cols):
    ...
    for label in labels:
        ...
        print("label:",label)
        #print("cur_label_belong:",cur_label_belong)
        ...
        #print(cur_row_width_step)
        #print(cur_col_height_step)
        # 文件名给予数据
        # child_type = []
        # child_num = []
        # label内容给予数据
...
def joint_main(big_images_path=r'/home/huangqing/YOLOv5small/src_images/val/images',
               labels_path=r'/home/huangqing/YOLOv5small/small_images/labels/val',
               yolo_labels_path=r'/home/huangqing/YOLOv5small/src_images/val/labels_yolo',
               mix_percent=0.3,
               rows=1,
               cols=10):
    ...
    print("运行三")
joint_main(big_images_path=r'/home/huangqing/YOLOv5small/src_images/val/images',
               labels_path=r'/home/huangqing/YOLOv5small/small_0.5/labels_yolo',
               yolo_labels_path=r'/home/huangqing/YOLOv5small/small_0.5/labels_joint',
               mix_percent=0.5,
               rows=1,
               cols=10)
