...
def draw_images(images_dir, txt_dir, box_dir):
...
def draw_main(box_dir=r'G:\Unity\all_data\big_images_box',
    ...
    draw_images(image_source_dir, txt_dir, box_dir)


draw_main(box_dir=r'/home/huangqing/YOLOv5small/src_images/val/labels',
              txt_dir=r'/home/huangqing/YOLOv5small/small_0.3/labels_test',
              image_source_dir=r'/home/huangqing/YOLOv5small/src_images/val/images',
)
