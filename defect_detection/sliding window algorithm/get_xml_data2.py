...
xml_path = r"/home/huangqing/YOLOv5_内螺纹/YOLOv5small/src_images/labels"
txt_path = r"/home/huangqing/YOLOv5_内螺纹/YOLOv5small/small_0.3/labels_txt"
images_path = r"/home/huangqing/YOLOv5_内螺纹/YOLOv5small/src_images/images"
#images_path = r"/home/huangqing/YOLOv5small/small_images/val"
file_names = os.listdir(xml_path)

#class_names = ['SA', 'LA', 'RA', 'SLA', 'SRA', 'SLRA', 'DM', 'CL', 'PC', 'BL', 'JB', 'SL', 'TR', 'PL', 'LTR']
# class_names = ['ignored regions', 'pedestrian', 'people', 'bicycle', 'car', 'van',
#               'truck', 'tricycle', 'awning-tricycle', 'bus', 'motor', 'others', 'LJ']

class_names = ['dust', 'Scratches']
...
def init_mix(w, h, split, mix_percent):
    ...
    for i in range(1):
        ...
        # print(mix_height_start)
        # print(mix_height_end)
        for j in range(9):
...
if __name__ == "__main__":
    ...
    for file_name in file_names:
       ...
       # file_name[:23]
        img_path=images_path + '/' + file_name.split('.')[0] + ".jpg"
        print("img_path")
        print(img_path)
