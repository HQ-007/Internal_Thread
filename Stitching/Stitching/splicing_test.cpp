...
Mat Image_Stitching(Mat imgsrc1, Mat imgsrc2, double image_x, double& image_y)
{
	...
	//相当于透视变换的结果
	Mat result1 = Mat::zeros(cvSize(image1.cols + image2.cols, max(image1.rows, image2.rows)), image1.type());
...
int main()
{
	...
	//string firstname = "E://内螺纹拍摄照片//不垂直//校正二//" + str + ".jpg";
	//string firstname = "E://内螺纹拍摄照片//拍摄6//水平校正后裁剪增强//" + str + ".jpg";
	string firstname = "G://内螺纹拍摄照片//53//倾斜校正增强//" + str + ".jpg";
	...
	for (int k = index + 1; k <= index + n - 1; k++) {
		...
		//string filename = "E://内螺纹拍摄照片//不垂直//校正二//" + str1 + ".jpg";
		string filename = "G://内螺纹拍摄照片//53//倾斜校正增强//" + str1 + ".jpg";
		...
		//string filename1 = "E://内螺纹拍摄照片//不垂直//校正二//" + str2 + ".jpg";
		string filename1 = "G://内螺纹拍摄照片//53//倾斜校正增强//" + str2 + ".jpg";
	...
	string resultname = "G://内螺纹拍摄照片//53//拼接结果//" + str3 + ".jpg";
