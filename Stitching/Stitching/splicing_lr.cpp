...
int main()
{
	...
	//string firstname = "E://内螺纹拍摄照片//拍摄7//水平校正后裁剪增强//" + str + ".jpg";
	//string firstname = "D://内螺纹拍摄照片//裁剪过后//裁剪四//倾斜校正加增强操作//" + str1 + ".jpg";
	//string firstname = "E://内螺纹拍摄照片//拍摄8//水平校正后裁剪增强//裁剪一//" + str + ".jpg";
	//string firstname = "E://内螺纹拍摄照片//偏离中心//校正//" + str + ".jpg";
	//string firstname = "E://内螺纹拍摄照片//金属螺母//水平校正//" + str + ".jpg";
	...
	//string firstname = "E://内螺纹拍摄照片//拍摄十九//校正//" + str + ".jpg";
	string firstname = "G://内螺纹拍摄照片//43//倾斜校正增强//" + str + ".jpg";
	...
	for (int k = index + 1; k <= index + n - 1; k++)
	{
		...
		//string filename = "E://内螺纹拍摄照片//拍摄7//水平校正后裁剪增强//" + str1 + ".jpg";
		//string filename = "E://内螺纹拍摄照片//金属螺母//水平校正//" + str1 + ".jpg";
		//string filename = "E://内螺纹拍摄照片//光滑物件//裁剪白边//" + str1 + ".jpg";
		//string filename = "E://内螺纹拍摄照片//拍摄8//水平校正后裁剪增强//裁剪一//" + str1 + ".jpg";
		//string filename = "E://内螺纹拍摄照片//大螺纹//校正//" + str1 + ".jpg";
		//string filename = "E://内螺纹拍摄照片//不垂直//校正//" + str1 + ".jpg";
		//string filename = "E://内螺纹拍摄照片//拍摄十九//校正//" + str1 + ".jpg";
		string filename = "G://内螺纹拍摄照片//43//倾斜校正增强//" + str1 + ".jpg";
		...
		//string filename1 = "E://内螺纹拍摄照片//金属螺母//水平校正//" + str2 + ".jpg";
		//string filename1 = "E://内螺纹拍摄照片//光滑物件//裁剪白边//" + str2 + ".jpg";
		//string filename1 = "E://内螺纹拍摄照片//拍摄8//水平校正后裁剪增强//裁剪一//" + str2 + ".jpg";
		//string filename1 = "E://内螺纹拍摄照片//不垂直//校正//" + str2 + ".jpg";
		//string filename1 = "E://内螺纹拍摄照片//拍摄十九//校正//" + str2 + ".jpg";
		string filename1 = "G://内螺纹拍摄照片//43//倾斜校正增强//" + str2 + ".jpg";
		...
		{
			image_x = left.cols - (right.cols - offset(index, right, true).first);//两个图像的拼接处
		}
	...
	stream3 >> str3;
	//保存文件名
	////string resultname = "E://内螺纹拍摄照片//拍摄7//拼接结果//" + str3 + ".jpg";
	...
	//string resultname = "E://内螺纹拍摄照片//拍摄8//拼接结果//" + str3 + ".jpg";
	//string resultname = "E://内螺纹拍摄照片//偏离中心//拼接结果//" + str3 + ".jpg";
	//string resultname = "E://内螺纹拍摄照片//金属螺母//拼接结果//" + str3 + ".jpg";
	//string resultname = "E://内螺纹拍摄照片//不垂直//拼接结果//" + str3 + ".jpg";
	//string resultname = "E://内螺纹拍摄照片//拍摄十九//拼接结果//" + str3 + ".jpg";
	//string resultname = "E://内螺纹拍摄照片//光滑物件//拼接结果//" + str3 + ".jpg";
	string resultname = "G://内螺纹拍摄照片//43//拼接结果//" + str3 + ".jpg";
